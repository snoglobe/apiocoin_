# Support for Output Descriptors in Apiocoin Core

Since Apiocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Apiocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Apiocoin Core wallets, a convenience function `combo` is
