...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 bees per kB (0.00001 APIO). This is to prepare for dropping the minimum transaction fee to 0.1 bees per kB (0.0001 APIO) in the next release.
