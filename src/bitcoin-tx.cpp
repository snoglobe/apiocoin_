...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " apiocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  apiocoin-tx [options] <hex-tx> [commands]  Update hex-encoded apiocoin transaction\n" +
            "or:     apiocoin-tx [options] -create [commands]   Create hex-encoded apiocoin transaction\n" +
            "\n";
