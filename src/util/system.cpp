...
const char * const BITCOIN_CONF_FILENAME = "apiocoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Apiocoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Apiocoin";
#else
    // Unix
    return pathRet / ".apiocoin";
#endif
#endif
}
