...
"""Verify that starting apiocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start apiocoin with -h for help text")
        ...
        self.log.info("Start apiocoin with -version for version information")
        ...
        self.log.info("Start apiocoind with -fakearg to make sure it does not start")
